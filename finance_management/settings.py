...
SECRET_KEY = 'django-insecure-yklp*$r4oy&7uq2209=6^yr*tfryp4bh!$2r1y8=#h22&74gts'
...
CRISPY_TEMPLATE_PACK = 'bootstrap4'  # Use the appropriate template pack
...
'''# In settings.py, configure authentication settings
